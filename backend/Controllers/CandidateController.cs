...
namespace backend.Controllers
{
    ...
    public class CandidateController : ControllerBase
    {
        ...
        {
            var candiadtes = await _context.Candidates.Include(c => c.Job).OrderByDescending(q => q.CreatedDate).ToListAsync();
            var convertedCandidates = _mapper.Map<IEnumerable<CandidateGetDto>>(candiadtes);
